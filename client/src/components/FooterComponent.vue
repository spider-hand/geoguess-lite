  ...
  <footer class="bg-gray-50 px-8 py-8">
    <div class="mx-auto max-w-7xl">
      <div class="flex flex-col items-center justify-between gap-4 md:flex-row">
        <div class="flex flex-row items-center gap-2 font-[JetBrains_Mono] text-xl font-semibold"> <svg
            xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 144 144" fill="none">
