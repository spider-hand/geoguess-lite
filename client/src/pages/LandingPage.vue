    ...
    >
      ...
      <div class="flex flex-col gap-10 md:flex-row md:items-end md:gap-16">
        <div class="flex flex-col gap-3 md:flex-1">
          <h3 class="font-[Roboto] text-3xl font-bold md:text-4xl">Play without limits</h3>
      ...
      <div class="flex flex-col gap-10 md:flex-row md:items-end md:gap-16">
        ...
        <div class="flex flex-col gap-3 md:flex-1">
          <h3 class="font-[Roboto] text-3xl font-bold md:text-4xl">
...
const features = [
  {
    title: 'No subscriptions, no paywalls',
    description:
      'GeoGuess Lite is designed to stay accessible without locking features behind subscriptions. You can play freely without creating an account or worrying about usage limits getting in the way.',
    icon: Feather,
  },
  {
    title: 'Open source and transparent',
    description:
      'GeoGuess Lite is built as an open source project, allowing anyone to explore, modify, and contribute. The code is fully accessible, giving you complete transparency and the freedom to run or adapt the experience in your own way.',
    icon: Puzzle,
  },
  {
    title: 'Community driven and flexible',
    description:
      'Designed to be flexible and community driven, GeoGuess Lite can be self hosted and extended to fit different needs. Whether you want to play casually or build on top of it, the platform is open to your ideas.',
    icon: Recycle,
  },
]
</script>
